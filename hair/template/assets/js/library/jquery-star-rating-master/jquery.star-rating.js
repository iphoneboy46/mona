...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		star: $('<i>').addClass('fa fa-star fa-light'),
		star_half: $('<i>').addClass('fa fa-star-half fa-light'),
		star_blank: $('<i>').addClass('fa fa-star-o fa-light'),
		star_half_blank: $('<i>').addClass('fa fa-star-half-o fa-light'),
		/*
