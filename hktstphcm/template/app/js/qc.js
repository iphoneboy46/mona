function Qc() {
    ...
    if (qc) {
        var mySwiperQcLf = new Swiper(qc.querySelector(".mySwiperQcLf"), {
            slidesPerView: "auto",
            lazy: !0,
            // pagination: {
            ...
            simulateTouch: false,
            navigation: {
                nextEl: qc.querySelector(".next"),
                prevEl: qc.querySelector(".prev"),
            },
            effect: "fade",
            fadeEffect: {
                // crossFade: true
        ...
        mySwiperQcLf.on("slideChange", () => {
            var activeIndex = mySwiperQcLf.realIndex;
            const qcItemRts = qc.querySelectorAll(".qc_box--rt-item");
            const qcItemRtShowed = qc.querySelector(".qc_box--rt-item.showed");
            if (qcItemRtShowed) {
                qcItemRtShowed.classList.remove("showed")
            }
            qcItemRts[activeIndex].classList.add("showed");
        ...
        mySwiperQcLf.on("slideChangeTransitionStart", () => {
