export default function DateJS() {
    const tourCtInfo = document.querySelector(".tourCt_infos");
    if (tourCtInfo) {


        const chooseDate1 = tourCtInfo.querySelector(".chooseDate1");
        if (chooseDate1) {
            ...
            $('.first').datepicker({
                ...
                onSelect: function (dateText) {
                    const textChange1 = tourCtInfo.querySelector(".text-date1");
                    let selectedDate = $(".first").val();
                    textChange1.innerText = selectedDate;
                    if(selectedDate.length > 0) {
                        const chooseDate2 = tourCtInfo.querySelector(".chooseDate2");
        ...
        if (chooseDate2) {
            ...
            $('.second').datepicker({
                ...
                dateFormat: 'dd/mm/yy',
                onSelect: function (dateText) {
                    const textChange2 = tourCtInfo.querySelector(".text-date2");
