...
const formCkLists = document.querySelectorAll(".form-ck-list ");
if (formCkLists) {
   formCkLists.forEach((formCkList)=>{
      const items = formCkList.querySelectorAll(".wpcf7-list-item");
      items.forEach((item,index) => {
      
         const box = item.querySelector(".wpcf7-list-item-label");
         ...
         item.addEventListener("click", () => {
            const boxShowed = formCkList.querySelector(".wpcf7-list-item-label.showed");
            if (boxShowed) {
               boxShowed.classList.remove("showed");
            }
            box.classList.add("showed");
         })
      })
